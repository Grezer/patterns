...
- (-) Если процедура создания объекта достаточно сложная (например выполняется на основе некоего внешнего условия), логично использовать паттерн [Фабрика](https://github.com/Grezer/patterns#factory-method-virtual-constructor), то есть, делегировать обязанность создания объектов специальному классу
...
> Какой класс должен обеспечивать реализацию паттернов [Высокое зацепление](https://github.com/Grezer/patterns#high-cohesion-%D0%B2%D1%8B%D1%81%D0%BE%D0%BA%D0%BE%D0%B5-%D0%B7%D0%B0%D1%86%D0%B5%D0%BF%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5), и [Слабая связанность](https://github.com/Grezer/patterns#low-coupling-%D1%81%D0%BB%D0%B0%D0%B1%D0%B0%D1%8F-%D1%81%D0%B2%D1%8F%D0%B7%D0%B0%D0%BD%D0%BD%D0%BE%D1%81%D1%82%D1%8C)?
...
1. [MVC](https://github.com/Grezer/patterns#mvc) (изобретаем сущность для решения инфрасируктурных проблем)

2. Появление презентеров, например [MVP](https://github.com/Grezer/patterns#mvp)
...
- <b>Точка вариации</b> (variation point) - точка ветвления в существующей на данный момент системе или в требованиях к ней, например, необходимость поддержки нескольких интерфейсов для системы вычисления налоговых платежей

- <b>Точка эволюции</b> (evolution point) - предполагаемая точка ветвления, которая может возникнуть в будущем, однако не определяемая существующими требованиями
...
<b>Полиморфизм в ООП</b> – это возможность обработки разных типов данных, т. е. принадлежащих к разным классам, с помощью "одно и той же" функции, или метода.  
...
<b>В данном контексте</b> шаблон Polymorphism решает проблему обработки альтернативных вариантов поведения на основе типа.  
...
Связанные паттерны: [ISP](https://github.com/Grezer/patterns#icp) и [Adapter](https://github.com/Grezer/patterns#adapter-wrapper)
